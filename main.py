...
links=pd.read_excel("marathafem.xlsx")
link=links["links"]
...
for i in link:
  try:
    ...
    os.mkdir("/content/drive/MyDrive/vlippr/marathi/female/speaker_"+a)
    ...
    for i, chunk in enumerate(audio_chunks):
      try:
        n=str(n)
        output_file = "/content/drive/MyDrive/vlippr/marathi/female/speaker_"+a+"/chunk{0}.wav".format(i)
...
df.to_csv("/content/drive/MyDrive/vlippr/assamese/male_data.csv")